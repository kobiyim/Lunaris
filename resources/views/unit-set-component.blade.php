            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Birim Setleri</h4>
                        <div class="row row-cols-lg-auto g-3 align-items-center">
                            <div class="col-12">
                                <label class="visually-hidden" for="inlineFormInputGroupUsername">Birim Setleri?</label>
                                <input type="text" class="form-control" wire:model.live.debounce.250ms="search" placeholder="Birim Setleri?">
                            </div>
                            <!--end col-->
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a wire:click="resetForm" data-bs-toggle="modal" data-bs-target="#unitSetModal" class="dropdown-item">Yeni Birim Seti</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!--end col-->
                                            ...
                                            <tr @if($set->active) class="table-success" @else class="table-danger" @endif>
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a wire:click="edit({{ $set->id }})" class="dropdown-item">Düzenle</a></li>
                                                            <li><a wire:click="confirmDelete({{ $set->id }})" class="dropdown-item">Sil</a></li>
                                                            <li><a wire:navigate href="{{ url('unit-set/' . $set->id) }}" class="dropdown-item">Birimleri</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
