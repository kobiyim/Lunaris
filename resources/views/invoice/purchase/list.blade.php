            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Satınalma Faturaları</h4>
                        <div class="row row-cols-lg-auto g-3 align-items-center">
                            <div class="col-12">
                                <label class="visually-hidden" for="inlineFormInputGroupUsername">Fatura?</label>
                                <input type="text" class="form-control" wire:model.live.debounce.250ms="search" placeholder="Fatura?">
                            </div>
                            <div class="col-12">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a wire:navigate href="{{ url('invoice/purchase/create') }}" class="dropdown-item">Yeni Fatura</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a wire:navigate href="{{ url('invoice/purchase/' . $fiche->id) }}" class="dropdown-item">İncele</a></li>
                                                            <li><a wire:navigate href="{{ url('invoice/purchase/' . $fiche->id  . '/edit') }}" class="dropdown-item">Düzenle</a></li>
